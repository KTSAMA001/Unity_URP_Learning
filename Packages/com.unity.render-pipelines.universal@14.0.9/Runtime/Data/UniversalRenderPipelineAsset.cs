...
namespace UnityEngine.Rendering.Universal
{
    ...
    public partial class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] Vector3 m_Cascade4Split = new Vector3(0.067f, 0.2f, 0.3f);
        //Add
        [SerializeField] float m_Cascade5Split = 0.6f;
        [SerializeField] Vector2 m_Cascade6Split = new Vector2(0.6f, 0.7f);
        [SerializeField] Vector3 m_Cascade7Split = new Vector3(0.6f, 0.7f, 0.8f);
        [SerializeField] Vector4 m_Cascade8Split = new Vector4(0.6f, 0.7f, 0.8f,0.9f);
        ...
        /// Returns the split values.
        /// </summary>
        /// <returns>Returns a Vector4 with the split values.</returns>
