...
half4 _DepthMaskColor1,_DepthMaskColor2;
half4 _BaseColor;
half4 _SpecColor;
half4 _EmissionColor;
half4 _EnvColor_Specular;
float3 _FaceShadowPosWS;
half _InsiteEdgeWidth;
half _DebugFloat;
half _HairShadowDistace;
half _FaceLightSDF_Offset,_FaceLightSDF_Add;
half _MatCapIntensity;
half _HaifHightLight_Bias,_HaifHightLight_Power, _HaifHightLight_Scale;
