#ifndef UNIVERSAL_GRASS_LIT_INPUT_INCLUDED
#define UNIVERSAL_GRASS_LIT_INPUT_INCLUDED
...
half _NoiseSmoothnessMin;
half _NoiseSmoothnessMax;
...
//Grass获取面板纹理               //Grass获取贴图的偏移与重复
TEXTURE2D(_NormalTex);          SAMPLER(sampler_NormalTex);
TEXTURE2D(_MetallicMap);        SAMPLER(sampler_MetallicMap);
TEXTURE2D(_RoughnessMap);       SAMPLER(sampler_RoughnessMap);
TEXTURE2D(_MaskHeightOffsetMap);       SAMPLER(sampler_MaskHeightOffsetMap);
